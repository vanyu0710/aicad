...
| `annular_groove` | remove | Yes | add/update/delete | Yes | Yes | No | No | External groove on tube |
| `internal_annular_groove` | remove | Yes | add/update/delete | Yes | Yes | No | No | Internal wall groove on tube |
| `boss_cylinder` | add | Yes | add/update/delete | Yes | Yes | Yes | No | Evidence binding only; no boss verifier yet |
